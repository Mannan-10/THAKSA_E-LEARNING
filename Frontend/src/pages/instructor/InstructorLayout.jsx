...
const navItems = [
  ...
  { to: "/instructor/course-content", label: "Course Content", icon: <PlayLessonRoundedIcon fontSize="small" /> },
  { to: "/instructor/attendance", label: "Student Attendance", icon: <EventAvailableRoundedIcon fontSize="small" /> },
