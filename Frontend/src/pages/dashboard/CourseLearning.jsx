  ...
  return (
    <div style={layout}>
      <div style={videoSection}>
        {currentLesson ? (
          <>
            <ReactPlayer url={currentLesson.video_url} controls width="100%" height="480px" />
            <h2 style={{ marginTop: "20px" }}>{currentLesson.title}</h2>

            {!currentLesson.completed ? (
              <button style={completeBtn} onClick={() => markAsComplete(currentLesson.id)}>
                Mark Complete
              </button>
            ) : (
          ...
          <div key={module.module_id}>
            ...
            {(module.lessons || []).map((lesson) => (
              <div
                ...
                style={{
                  ...lessonItem,
                  background: currentLesson?.id === lesson.id ? "#e0f2fe" : "transparent",
                }}
